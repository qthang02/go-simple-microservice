...
var File_service_micro_proto protoreflect.FileDescriptor

var file_service_micro_proto_rawDesc = []byte{
	0x0a, 0x13, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb7, 0x01, 0x0a, 0x07, 0x4d, 0x69, 0x63, 0x72, 0x6f, 0x47, 0x6f,
	...
	0x2f, 0x76, 0x31, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x42, 0x1b,
	0x5a, 0x19, 0x61, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var file_service_micro_proto_goTypes = []interface{}{
...
var file_service_micro_proto_depIdxs = []int32{
	0, // 0: pb.MicroGo.CreateUser:input_type -> pb.CreateUserRequest
	1, // 1: pb.MicroGo.LoginUser:input_type -> pb.LoginUserRequest
	2, // 2: pb.MicroGo.CreateUser:output_type -> pb.CreateUserResponse
	3, // 3: pb.MicroGo.LoginUser:output_type -> pb.LoginUserResponse
...
func init() { file_service_micro_proto_init() }
func file_service_micro_proto_init() {
	if File_service_micro_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_service_micro_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_service_micro_proto_goTypes,
		DependencyIndexes: file_service_micro_proto_depIdxs,
	}.Build()
	File_service_micro_proto = out.File
	file_service_micro_proto_rawDesc = nil
	file_service_micro_proto_goTypes = nil
	file_service_micro_proto_depIdxs = nil
}
